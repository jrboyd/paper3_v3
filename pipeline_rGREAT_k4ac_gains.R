...
STEIN_SUBSET = get_res(res = STEIN_ChIPseq, cell = "MCF7", mark = "H3K4AC")
...
setwd(output_dir)
sub_dir = "GREAT_comparisons_k4ac/to_ctrl_truncated"
...
hmap_col = rgb(colorRamp(c("white", "white", "beige", "red", "magenta"))(0:100/100)/255)

pdf("k4ac_msig_enrichments.pdf")
