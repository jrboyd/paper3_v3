...
ext = 1500
k = ensg_prom$strand == "+"
ensg_prom[k,"end"] = ensg_prom[k,"start"] + ext
ensg_prom[k,"start"] = ensg_prom[k,"start"] - ext
k = !k
ensg_prom[k,"start"] = ensg_prom[k,"end"] - ext
ensg_prom[k,"end"] = ensg_prom[k,"end"] + ext
...
min_fdr=.05
min_FC = 1
save_filename = paste0("input/", paste0("DM_lists.ensg.padj", min_fdr, ".fc", min_FC, ".save"))
