...
STEIN_SUBSET = get_res(res = STEIN_ChIPseq, cell = "MCF7", mark = "H3K4ME3")
...
setwd(output_dir)
sub_dir = "GREAT_comparisons_k4me3/to_ctrl_truncated"
...
hmap_col = rgb(colorRamp(c("white", "beige", "red", "magenta","magenta", "magenta", "magenta"))(0:100/100)/255)

pdf("k4me3_msig_enrichments.pdf")
