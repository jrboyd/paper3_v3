...
for(m in marks){
  ...
  setwd(output_dir)
  sub_dir = paste0("GREAT_comparisons_MCF10A_enhancers_from_ctrl/", m)
  ...
  a = compare_drugs("ctrl", "bza", with = F, enh_only = T)
  a = compare_drugs("ctrl", "e2", with = F, enh_only = T)
  a = compare_drugs("ctrl", "e2bza", with = F, enh_only = T)
  a = compare_drugs("ctrl", "gc10", with = F, enh_only = T)
  a = compare_drugs("ctrl", "gc10bza", with = F, enh_only = T)
  
  a = compare_drugs("bza", "ctrl", with = F, enh_only = T)
  a = compare_drugs("e2", "ctrl", with = F, enh_only = T)
  a = compare_drugs("e2bza", "ctrl", with = F, enh_only = T)
  a = compare_drugs("gc10", "ctrl", with = F, enh_only = T)
  a = compare_drugs("gc10bza", "ctrl", with = F, enh_only = T)
  ...
  pdf(paste0(m, "_from_ctrl_enhancers_msig_enrichments.pdf"))
